...
let kSafeAreaTopHeight : CGFloat = Int(kStatusBarHeight) > 20 ? 88.0 : 64.0
let kTabBarHeight: CGFloat = Int(kStatusBarHeight) > 20 ? 83 : 49
let kSafeAreaBottomHeight: CGFloat = Int(kStatusBarHeight) > 20 ? 34 : 0
...
public let kTopHeight = 44 + kStatusBarHeight
...
public let PDPaperType = "mt800_paperType_A4"
